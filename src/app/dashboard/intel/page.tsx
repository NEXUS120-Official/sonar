...
export default async function IntelPage() {
  ...
  return (
    <div className="p-6 lg:p-8 flex flex-col gap-8">
      ...
      {/* Joined Intelligence entrypoint */}
      <Link
        href="/dashboard/joined-intelligence"
        className="block rounded-xl border p-5 transition hover:opacity-90"
        style={{ background: '#12121a', borderColor: '#1e1e2e' }}
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="text-lg font-semibold">Joined Intelligence</h2>
            <p className="text-sm mt-2 max-w-3xl" style={{ color: '#6b6b80' }}>
              Persisted canonical intelligence records across valuation, privacy, lineage, and attribution.
            </p>
          </div>
          <div className="text-sm font-medium shrink-0" style={{ color: '#22d3ee' }}>
            Open dashboard →
